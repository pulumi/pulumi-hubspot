...
import { ContactPropertyProps, ManageOnlyCheckKeys, ManageOnlyDeleteCheckKeys } from "../../types/ContactProperty";
...
class ContactPropertyProvider implements pulumi.dynamic.ResourceProvider {
    ...
    private managementOnlyField(args: ContactPropertyProps): boolean {
