...
export type ManageOnlyCheckKeys = "calculated" | "readOnlyDefinition";
export type ManageOnlyDeleteCheckKeys = "mutableDefinitionNotDeletable" | "calculated" | "readOnlyDefinition";
...
export interface ContactPropertyApiArgs {
    // If the property was originally created in HubSpot and now managed by Pulumi.
...
export interface ContactPropertyProps {
    ...
    // The internal name of the property. The name should always be used when referencing the property through the API.
    // Pulumi will automatically use the name apply the name used in the constructor to this field. So defining a value
    // in this field is a futile effort.
    name?: string;
}
